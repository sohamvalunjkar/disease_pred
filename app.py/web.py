...
diabetes_model = pickle.load(open(r"models\db_dataset.sav", 'rb'))
heart_disease_model = pickle.load(open(r"models\ht_dataset.sav", 'rb'))
parkinsons_model = pickle.load(open(r"models\pk_dataset.sav", 'rb'))
