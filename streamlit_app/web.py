...
diabetes_model = pickle.load(open(r"pickle file\db_dataset.sav", 'rb'))
heart_disease_model = pickle.load(open(r"pickle file\ht_dataset.sav", 'rb'))
parkinsons_model = pickle.load(open(r"pickle file\pk_dataset.sav", 'rb'))
